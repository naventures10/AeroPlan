...
export function MobileTafWidget({ weather }: MobileTafWidgetProps) {
  return (
    ...
    >
      ...
      <div className="bg-surface-container p-4 rounded-2xl border border-outline-variant flex flex-col justify-between max-h-[45vh] overflow-y-auto aip-scrollbar">
        <div>
