...
export const SECTION_COLUMNS: Record<string, SectionColumnConfig> = {
  ...
  AD_2_2: {
    ...
    columns: [
      ...
      {
        key: 'direction_distance',
        label: 'Direction and distance from the centre of the city or town',
      },
      { key: 'elevation_reference_temp', label: 'Aerodrome elevation and reference temperature' },
      {
        key: 'magnetic_variation',
        label: 'Magnetic variation, date of information and annual change',
      },
      {
        key: 'operator_details',
        label:
          'Name of aerodrome operator, address, telephone, telefax, e-mail address, AFS address',
      },
  ...
  AD_2_8: {
    ...
    columns: [
      {
        key: 'aprons_designation_surface_strength',
        label: 'Designation, Surface and Strength of Aprons',
      },
      {
        key: 'taxiways_designation_width_surface_strength',
        label: 'Designation, Width, Surface and Strength of Taxiways',
      },
  ...
  AD_2_9: {
    ...
    columns: [
      {
        key: 'use_of_signs_and_guidance',
        label:
          'Use of Aircraft Stand Identification Signs, Taxiing Guidance and Visual Docking/Parking Guidance System',
      },
      {
        key: 'runway_and_taxiway_markings_and_lights',
        label: 'Runway and Taxiway Markings and Lights',
      },
  ...
  AD_2_11: {
    ...
    columns: [
      { key: 'associated_met_office', label: 'Name of the Associated Meteorological Office' },
      {
        ...
        label: 'Hours of Service and Designation of Responsible MET Office Outside These Hours',
      },
      {
        key: 'office_responsible_for_taf_preparation',
        label: 'Office Responsible for TAFs and Periods of Validity',
      },
      { key: 'trend_forecast_availability', label: 'Availability of the Trend Forecast' },
      {
        key: 'briefing_and_consultation_provided',
        label: 'Information on How Briefing/Consultation is Provided',
      },
      {
        key: 'flight_documentation_supplied',
        label: 'Types of Flight Documentation Supplied and Language',
      },
      {
        key: 'charts_and_other_info_available',
        label: 'Charts and Other Info Available for Briefing',
      },
      { key: 'supplementary_equipment_available', label: 'Supplementary Equipment Available' },
      {
        key: 'ats_units_provided_with_info',
        label: 'Air Traffic Services Unit Provided with Information',
      },
  ...
  AD_2_15: {
    ...
    columns: [
      {
        key: 'aerodrome_beacon_identification_beacon',
        label: 'Aerodrome Beacon / Identification Beacon',
      },
      {
        key: 'anemometer_landing_direction_indicator',
        label: 'Anemometer / Landing Direction Indicator',
      },
      { key: 'taxiway_edge_centre_line_lights', label: 'Taxiway Edge and Centre Line Lights' },
      {
        key: 'secondary_power_supply_switch_over_time',
        label: 'Secondary Power Supply Including Switch-Over Time',
      },
      { key: 'remarks', label: 'Remarks' },
    ] as ObjectColumnDef[],
  },
  ...
  AD_2_16: {
    ...
    columns: [
      ...
      {
        key: 'dimensions_surface_strength_marking',
        label: 'TLOF and FATO Area Dimensions, Surface, Strength, Marking',
      },
  ...
  AD_2_17: {
    ...
    columns: [
      {
        key: 'designation_and_lateral_limits',
        label: 'Airspace Designation, Geographical Coordinates and Lateral Limits',
      },
