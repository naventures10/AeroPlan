  ...
  return (
    <div ref={dropdownRef} className="relative z-50">
      ...
      <button
        ...
        className={`flex items-center gap-2.5 px-4 py-2.5 rounded-xl backdrop-blur-xl shadow-xl transition duration-300 [transition-property:backdrop-filter,-webkit-backdrop-filter] focus:outline-none border ${
          isOpen
