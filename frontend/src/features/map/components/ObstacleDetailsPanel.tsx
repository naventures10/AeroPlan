  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="flex flex-col">
        ...
        <span className="text-sm text-white font-mono">{elevStr}</span>
      </div>
      <div className="flex flex-col">
      ...
      {extraInfo && (
        <>
          <div className="flex flex-col">
            ...
            <span className="text-sm text-white">{extraInfo.area_affected || 'N/A'}</span>
          </div>
          <div className="flex flex-col">
            <span className="text-xs text-default-500 font-semibold tracking-wider">
              LGT / MARKING
            </span>
            <span className="text-sm text-white">{extraInfo.marking_lgt || 'N/A'}</span>
          </div>
          <div className="flex flex-col">
            <span className="text-xs text-default-500 font-semibold tracking-wider">REMARKS</span>
            <span className="text-sm text-white">{extraInfo.remarks || 'N/A'}</span>
          </div>
        </>
      )}
    </div>
