      ...
      {isEnroute2D && (
        ...
        >
          ...
          <button
            ...
            className="flex items-center justify-center w-9 h-9 rounded-full text-on-surface-variant hover:text-[var(--accent-cyan)] hover:bg-[var(--accent-cyan-opacity-10)] transition duration-300 focus:outline-none"
          >
            <Compass
              size={20}
              strokeWidth={2}
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <button
              ...
              title="Zoom In"
              className="flex items-center justify-center w-8 h-8 rounded-full text-on-surface-variant hover:text-[var(--accent-cyan)] hover:bg-[var(--accent-cyan-opacity-10)] transition duration-300 focus:outline-none"
            >
