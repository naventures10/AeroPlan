...
describe('useKeyboardShortcuts', () => {
  ...
  it('should call returnToEnroute when Escape is pressed and in TERMINAL mode', async () => {
  ...
  it('should cancel pending selection when Escape is pressed and routes are selected', async () => {
  ...
  it('should call onCloseSectionModal on Escape when modal is open', async () => {
    renderHook(() => useKeyboardShortcuts({
  ...
  it('should ignore input when focused in an input field', async () => {
    renderHook(() => useKeyboardShortcuts({
      sectionModalOpen: false,
      onCloseSectionModal: onCloseSectionModalMock,
      cancelPendingSelection: cancelPendingSelectionMock
