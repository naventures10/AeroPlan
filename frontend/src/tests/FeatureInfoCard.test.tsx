...
describe('FeatureInfoCard Component', () => {
  ...
  it('renders nothing when selectedFeature is null', async () => {
  ...
  it('renders WAYPOINT data correctly', async () => {
  ...
  it('renders ATS_ROUTE data correctly', async () => {
    useMapStore.setState({
      viewMode: 'ENROUTE',
      selectedFeature: {
        type: 'ATS_ROUTE',
  ...
  it('renders NAVAID data correctly', async () => {
    useMapStore.setState({
      viewMode: 'ENROUTE',
      selectedFeature: {
        type: 'NAVAID',
  ...
  it('renders AIRSPACE data correctly and handles close', async () => {
