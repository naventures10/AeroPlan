...
describe('ConditionsWidget', () => {
  ...
  it('renders correctly with full data', () => {
    render(<ConditionsWidget icaoCode="VAAU" parsedMetar={mockMetar as any} daylight={mockDaylight} todayStr="2024-01-01" />);
  ...
  it('renders correctly with VRB wind', () => {
    ...
    render(<ConditionsWidget icaoCode="VAAU" parsedMetar={vrbMetar as any} daylight={mockDaylight} todayStr="2024-01-01" />);
  ...
  it('renders correctly with empty data', () => {
    ...
    render(<ConditionsWidget icaoCode="VAAU" parsedMetar={emptyMetar as any} daylight={null} todayStr="2024-01-01" />);
    expect(screen.getByText('VAAU')).toBeInTheDocument();
