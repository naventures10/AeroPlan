...
class AirspaceETL:
    ...
    def extract(self, pdf_path: str) -> gpd.GeoDataFrame:
        ...
        try:
            ...
            output = subprocess.check_output(cmd_info, stderr=subprocess.STDOUT, timeout=60).decode("utf-8")
            available_layers = []
        ...
        for layer_str in WHITELIST:
            ...
            try:
                ...
                subprocess.run(cmd_extract, check=True, capture_output=True, timeout=EXTERNAL_CMD_TIMEOUT)
