...
class CoordinateParser:
    ...
    @staticmethod
    def parse_to_decimal(val: str, hemi: str, minutes: str = None, seconds: str = None) -> float:
...
class AirspaceMetadataETL:
    ...
    def process_file(self, file_key: str):
        ...
        elif "military_exercise_and_training_areas" in data or "air_defence_identification_zones_adiz" in data:
        ...
        for table in data.get("upr_zones_raw_tables", []):
            for row in table:
                ...
                if "The UPR airspace for the" in text_content:
                    print(f"    [*] Found descriptive UPR text in table")
