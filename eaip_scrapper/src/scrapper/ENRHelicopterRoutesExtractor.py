...
class ENRHelicopterRoutesExtractor(BaseENRExtractor):
    ...
    def __init__(self, active_eaip_url, session=None, output_file="output/enr_3_3_1_helicopter_routes.json"):
        super().__init__(
    ...
    def _extract_data(self):
                ...
                if "ROUTE" in header or "RADIAL" in header or "DESIGNATOR" in header:
                    for row in grid[2:]:
                        ...
                        if col_count == 6:
                            ...
                            if "FROM" in col0.upper() or "RADIAL" in col0.upper(): continue
                        ...
                        # Handle Kolkata style (Designator, Route, Remarks) mapped across 8 cols
                            ...
                            col0 = clean(row[0])
                            if "DESIGNATOR" in col0.upper() or "ROUTE" in col0.upper(): continue
        ...
        print(f"[+] Extracted {len(helipads)} Helipads, {len(routes)} Routes, and {len(guidelines)} flight rules.")
