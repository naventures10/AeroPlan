...
class ENRMilitaryExerciseAreasExtractor(BaseENRExtractor):
    ...
    def __init__(self, active_eaip_url, session=None, output_file="output/enr_5_2_military_exercise_adiz.json"):
        super().__init__(
    ...
    def _extract_data(self):
        ...
        print(f"[+] Extracted {len(military_exercise_areas)} Military Exercise Areas, {len(adiz_zones)} ADIZ zones.")
