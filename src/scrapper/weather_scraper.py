...
def main():
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=20) as executor:
        future_to_icao = {executor.submit(fetch_station_data, icao): icao for icao in stations}
    ...
    print(f"Done! Successfully generated JSON payload with {len(results)} weather records.")
